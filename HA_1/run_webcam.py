...
def main():
	...
	if(args.video_out):
		...
		out = cv2.VideoWriter(args.video_out + '.avi',fourcc, 30.0, (CROP_SIZE*2,CROP_SIZE))
...
if __name__ == '__main__':
	...
	parser.add_argument('--video_in', dest='video_in', type=str, default='', help='Video file for remade.')
	parser.add_argument('--video_out', dest='video_out', type=str, default='', help='Video file for remade.')
