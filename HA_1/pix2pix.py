...
parser.add_argument("--scale_size", type=int, default=536, help="scale images to this size before cropping to 256x256")
...
def create_model(inputs, targets):
    def create_discriminator(discrim_inputs, discrim_targets):
        ...
        # layer_3: [batch, 128, 128, ndf ] => [batch, 64, 64, ndf * 4]
        # layer_4: [batch, 64, 64, ndf * 2] => [batch, 32, 32, ndf * 8]
